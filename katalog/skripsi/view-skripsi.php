...
<div class="wrapper">
    <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" class="close" onclick="window.location.href='data-skripsi.php';" aria-label="Close">
    ...
    <textarea name="judul_skripsi" class="form-control bold-black-text" readonly><?= $skripsi['Judul_Skripsi'] ?></textarea>
            ...
            <div class="card-footer">
                <button class="btn btn-primary" onclick="window.location.href='data-skripsi.php';">Kembali</button>
            </div>
        </div>
    </div>
</div>
