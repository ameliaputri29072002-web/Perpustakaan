...
$title = "FORM User - E-KATALOG PERPUSTAKAAN";
...
if (isset($_POST['simpan'])) {
    if (insert($_POST) > 0) {
      echo"<script>
                document.location.href = 'data-user.php?msg=insert';
      </script>";
    }
  }
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 text-center">
                        <img src="http://localhost/katalog/asset/image/default.jpeg" class="profile-user-img img-circle mb-3" alt="">
                        <input type="file" class="form-control" name="image">
                        <span class="text-sm">Type file gambar JPG | PNG | GIF <br>
                        </span>
