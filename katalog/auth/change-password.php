...
$title = "Change Password - E-KATALOG PERPUSTAKAAN";
...
if (isset($_POST['submit'])) {
  if (update($_POST)) {
    echo "<script>
            ...
            dokument.location='change-password.php';
          </script>";
  }
}
            ...
            <div class="card">
                <form action="" method="post">
                    <div class="card-header">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary btn-sm float-right"><i class="fas fa-edit"></i> Submit</button>
                    ...
                    <div class="card-body">
                        <div class="col-lg-8 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="confPass" id="confPass" class="form-control" placeholder="masukan kembali password baru anda" required>
                            </div>
                        </div>
                    </div>
                </form>
